...
for case in cases:
    ...
    RK311Data = dataframes[case].loc[["RK311"],["MPIprocs","wallTime"]]
    otherIntegData = dataframes[case].loc[[otherIntegName],["MPIprocs","wallTime"]]
   
    eta[case] =  {}
    eta[case]["MPIprocs"] = otherIntegData.loc[:,["MPIprocs"]].values
    eta[case]["eta"] = (1 - otherIntegData.loc[:,["wallTime"]].values/RK311Data.loc[:,["wallTime"]].values)*100
...
plt.tight_layout()
plt.savefig('./figures/fixed-courant-wallTime-eta.pdf',transparent=True)
plt.show()